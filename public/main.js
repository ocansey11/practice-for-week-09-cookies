...
function storeTheme(themeName) {
  // Your code here
  document.cookie = `themeName=${themeName}; expires=Tue, 27 Dec 2023 15:48:30 UTC; path=/;`;
}
...
function clearTheme() {
  // Your code here
  document.cookie = `themeName=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/;`;
}
...
function storeName(displayName) {
  // Your code here
  document.cookie = `displayName=${displayName}; expires=Thu, 01 Jan 2024 00:00:00 UTC; path=/;`;
}
...
function restoreName() {
  ...
  if (document.cookie) {
    let cookie = document.cookie;
    cookie = cookie.split(";");
    if (cookie[1].includes("displayName")) {
      cookie = cookie.split("=");
    }
  }
}
